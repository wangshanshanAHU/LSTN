function [dJdW,dJdB] = getDelta(Lt,Ls,LYs,W,b,hs,ht,opts,Z)
% alpha = opts.alpha;
% beta = opts.beta;
% gamma = opts.gamma;
...
dJdW =  2*opts.beta1*Ls*hs' -2*opts.beta1*Lt*ht'+2*opts.beta2*LYs*hs'+  2*opts.gamma1 * W;
dJdB = 2*opts.beta1*meanLs- 2*opts.beta1*meanLt+2*opts.beta2*meanLYs+ 2*opts.gamma1 * b;
